...
import Popup from 'vic-common/lib/components/antd-mobile/popup';
...
function getEmptyContentForPopup() {
  return (<div className="popup-list-empty">
    <div className="con">暂无内容</div>
  </div>);
}

export function showPopup(headerTitle, content) {
  Popup.show(<div className="popup-list">
    <List renderHeader={() => popupRenderHeader(headerTitle)}>
    {(content ? content : getEmptyContentForPopup())}
    </List>
